...
Kept in sync with pipecat-primd/tests/test_client.py until both packages
share a single client crate.
"""
...
from livekit_primd import Hit, PrimdClient, QueryResult
